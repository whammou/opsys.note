...
#+FILETAGS: :typDoc:subProject:OPSYS:REMOTE:DRIVE:
#+HTML:<details>

* DONE Cloud Drives :typDoc:meta:OPSYS:REMOTE:DRIVE:
CLOSED: [2025-06-10 Tue 01:10]
#+HTML:</details>
- *OBJECTIVE:* /Manage data in cloud drives/
** PRTL Config rclone [100%] :subRclone:
...
** DONE Obtain google-drive API key :opDrive:
...
** DONE Quickly toggle drive :subRofi:
CLOSED: [2025-06-10 Tue 01:10]
