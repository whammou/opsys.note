...
#+FILETAGS: :topOpsys:typDoc:subProject:REMOTE:DRIVE:
- *OBJECTIVE:* /Manage data in cloud drives/
* PRTL [#A] Config rclone [100%] :subRclone:
...
* DONE [#A] Obtain google-drive API key :opDrive:
...
* DONE [#A] Quickly toggle drive :subRofi:
