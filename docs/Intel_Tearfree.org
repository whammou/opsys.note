...
#+FILETAGS: :topOpsys:typDoc:subProject:LINUX:INTEL:
...
* DONE [#A] Fix kitty tear free :subKitty:
...
* DONE [#A] Fix qutebrowser tear free :subQutebrowser:
CLOSED: [2025-05-21 Wed 18:01]
- *Objective:* /Achieve tearless with qutebrowser/
* DONE [#A] Fix mpv tear :MPV:
