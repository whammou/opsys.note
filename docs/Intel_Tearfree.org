...
#+FILETAGS: :typDoc:subProject:OPSYS:LINUX:INTEL:
#+HTML:<details>

* DONE Linux Screen Tear [100%] :typDoc:meta:OPSYS:LINUX:INTEL:
...
** DONE Fix kitty tear free :subKitty:
...
** DONE Fix qutebrowser tear free :subQutebrowser:
CLOSED: [2025-05-21 Wed 18:01]
