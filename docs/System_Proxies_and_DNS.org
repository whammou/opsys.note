...
#+FILETAGS: :typDoc:subProject:OPSYS:LINUX:NETWORK:
#+HTML:<details>

* PEND System Proxies and DNS :typDoc:meta:OPSYS:LINUX:NETWORK:
#+HTML:</details>
Access blocked websites via ~proxy~ or ~DNS~
** DONE Reverse Tunneling :PROTOCOL:subSsh:reversetunneling:
