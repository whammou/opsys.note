...
3.  Start =fail2ban= systemd service:
    ...
    #+END_SRC
** DOIN Homelab Remote Access Via VPN :VPN:WIREGUARD:
...
*** DONE VPN protocols :vpn-protocol:
...
**** SoftEther :softether:
[[file:https://www.paloaltonetworks.com/content/dam/pan/en_US/images/cyberpedia/SoftEther-v1.png]]
