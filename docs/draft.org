...
-  =SSTP=  works by channeling VPN traffic through the SSL 3.0 channel. This means it can benefir from features like SSL's integrated connection integrity and encryption capabilities
