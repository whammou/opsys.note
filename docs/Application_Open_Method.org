...
#+FILETAGS: :typDoc:subProject:OPSYS:LINUX:
#+HTML:<details>

* DONE Application Open Method [100%] :typDoc:meta:OPSYS:LINUX:
...
** DONE Open with handlr :subHandlr:
